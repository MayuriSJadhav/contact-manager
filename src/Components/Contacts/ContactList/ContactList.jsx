...
const ContactList = () => {
  ...
  return (
    <React.Fragment>
      ...
      <section className="contact-search p-3">wwh
          ...
          <div className="grid">
            <div className="row">
              <div className="col">
                ...
                <p className='fst-italic'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Necessitatibus tempore voluptatem veniam at, voluptatum magnam nihil, illo ex commodi cupiditate mollitia perferendis? Facilis dicta cupiditate optio minima, dignissimos eius nesciunt.</p>
              </div>
            </div>
            {/* row-2 */}
            <div className="row">
